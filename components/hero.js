  ...
  return (
    <section className="bg-transparent z-10 relative">
        ...
        <div class="text-center mt-8 md:mt-16">
            <h1 class="text-4xl md:text-6xl font-bold text-white astro-title">astroCET</h1>
            <p class="text-white mt-4 font-thin">COLLEGE OF ENGINEERING TRIVANDRUM</p>
      ...
      AstroCET is the esteemed astronomy club of the College of Engineering 
Trivandrum (CET). AstroCET has embarked on a journey of astronomical 
proportions over the past year. Established in 2019 as a humble hobby club, 
AstroCET has now evolved into a beacon of celestial exploration, fostering 
camaraderie among students while diving deeper into the technical facets of the 
cosmos.
</p>
        ...
        <div class="mt-4 md:mt-16 mx-auto max-w-4xl">
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-0">
              ...
              <h2 class="text-xl font-bold">Vision</h2>
               <p class="md:px-10 mt-2 italic text-lg font-serif">AstroCET aims to lead in astronomy education and outreach, inspiring students and the public to explore the cosmos. By fostering skill development, collaborating with institutions, and promoting innovation, the club seeks to create an inclusive environment, expand its reach, and contribute to scientific knowledge.</p>
                ...
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  <svg class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                    ...
                    <p class="md:px-10 mt-2 italic text-lg font-serif">The club's primary mission is to ignite a passion for astronomy among 
  students and the general public, providing a platform for learning, exploration, 
  and innovation.
</p>
