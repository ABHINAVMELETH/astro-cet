...
const teamMembers = [
  { name: 'AJITH JEEJO', role: 'OUTREACH LEAD', imgSrc: '/images/SELFPHOTO.jpg',linkedIn: 'https://www.linkedin.com/in/naveenvarma', email: 'naveen@example.com' },
...
const Outreachcurrent = () => {
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-4xl text-6xl font-bold astro-title2 mb-10 text-center mt-20 mb-20">outreach team</h1>
...
export default Outreachcurrent;
